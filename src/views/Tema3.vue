...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.justify-content-center.align-items-center.mb-5(data-aos="fade-left")
      ...
      p.mb-3 Son muchos los factores que determinan la cantidad ofrecida, uno de ellos es el precio, quien desempeña un papel muy importante en el momento en que los empresarios y emprendedores desean poner a disposición de sus clientes los bienes que comercializan.
      ...
      p.mb-3 La forma de las curvas de oferta variará de acuerdo con el producto: más inclinada, más plana, más recta o más curvada. Sin embargo, casi todas las curvas de oferta presentan una similitud fundamental: se inclinan hacia arriba de izquierda a derecha e ilustran la ley de oferta. 
